...
const METRIC_CONFIGS: Record<SupportedMetric, MetricConfig> = {
  temperature: {
    ...
    demoRange: "38.0 – 44.0 °C (Normal Baseline)",
  ...
  vibration: {
    ...
    demoRange: "0.20 – 0.35 g (Normal Baseline)",
  ...
  current: {
    ...
    demoRange: "3.80 – 4.50 A (Normal Baseline)",
  ...
  speed: {
    ...
    demoRange: "1.70 – 1.90 m/s (Normal Baseline)",
  ...
  alignment: {
    ...
    demoRange: "-2.0 – +2.0 mm (Normal Baseline)",
  ...
  load: {
    ...
    demoRange: "50.0 – 70.0 % (Normal Baseline)",
